    ...
    <div className={clsx(s.container, className)}>
      <div className={s.block}>
        ...
        <Text view={'body'}>
          ...
          play table tennis, write music, love movies, enjoy dancing, and dream of creating stories.
          Each of these passions is a part of me. Below, you’ll find a glimpse into each of them.
        </Text>
      </div>
    </div>
  );
